...
from exec_scripts.OV_SQL_CLOB130135 import main as clob_run
...
def do_insert_cmcc_user_info(thread_id, my_port):
    ...
    while True:
        try:
            con.short_execute_sql(DiyBusiness().insert_sql_cmcc_user_info(i, str(thread_id).zfill(3), str(my_port)))
            i = i + 1
            j = j + 1
            if j == 1000:
                socket_client_for_statistics('192.168.3.118', 'do_insert_cmcc_user_info--' + str(j), 45678)
                j = 0
        except Exception:
            con_list = sel_con()
            if len(con_list) != 0:
...
def do_update_diy():
    ...
    while True:
        try:
            ...
            j = j + 1
            if j == 1000:
                socket_client_for_statistics('192.168.3.118', 'do_update_diy--' + str(j), 45678)
                j = 0
        except Exception:
            con_list = sel_con()
            if len(con_list) != 0:
...
def transfer_pro():
    ...
    while True:
        try:
            ...
            i = i + 1
            if i == 1000:
                socket_client_for_statistics('192.168.3.118', 'transfer_pro--' + str(i), 45678)
                i = 0
        except Exception:
            con_list = sel_con()
            if len(con_list) != 0:
...
def delete_sql():
    ...
    while True:
        try:
            ...
            i = i + 1
            if i == 1000:
                socket_client_for_statistics('192.168.3.118', 'delete_sql--' + str(i), 45678)
                i = 0
        except Exception:
            con_list = sel_con()
            if len(con_list) != 0:
...
def call_order_product():
    ...
    while True:
        try:
            ...
            i = i + 1
            if i == 1000:
                socket_client_for_statistics('192.168.3.118', 'call_order_product--' + str(i), 45678)
                i = 0
        except Exception:
            con_list = sel_con()
            if len(con_list) != 0:
...
def call_order_product_clob():
    ...
    while True:
        try:
            ...
            i = i + 1
            if i == 1000:
                socket_client_for_statistics('192.168.3.118', 'call_order_product_clob--' + str(i), 45678)
                i = 0
        except Exception:
            con_list = sel_con()
            if len(con_list) != 0:
...
def call_cancel_account():
    ...
    while True:
        try:
            ...
            i = i + 1
            if i == 1000:
                socket_client_for_statistics('192.168.3.118', 'CALL_cancel_account--' + str(i), 45678)
                i = 0
        except Exception:
            con_list = sel_con()
            if len(con_list) != 0:
...
def call_cancel_account_clob():
    ...
    while True:
        try:
            ...
            i = i + 1
            if i == 1000:
                socket_client_for_statistics('192.168.3.118', 'CALL_cancel_account_clob--' + str(i), 45678)
                i = 0
        except Exception:
            con_list = sel_con()
            if len(con_list) != 0:
...
def main_insert(n):
    for a in range(n):
        '''每个节点做不同表的insert'''
        p_in_1 = td.Thread(target=do_insert_cmcc_user_info, args=(a, port[0]))
...
def main():
    ...
    # main_trans(1)
    # main_update(1)
    # main_order_product(1)
    # main_order_product_clob(1)
    # main_delete(1)
    # main_call_cancel_account(1)
    # main_call_cancel_account_clob(1)
    # main_clear_sql(1)
